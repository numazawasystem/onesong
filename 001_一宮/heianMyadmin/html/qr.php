...
<body>
		...
		<div class="inner">
			<div id="contents">
				<div id="main">
					...
					※QRコードのリンク先は【
					<?php
						$date = new DateTime($row22['valid_until']);
						print($date->format('Y年n月j日'));
					?>
					】までご利用いただけます。<br />
					期限を過ぎるとアクセスできなくなりますのでご注意ください。<br /><br />
	...
	<!--/container-->
	<script>
	const url = "https://owakare-ai001.chunichi-eizo.jp/?data=<?php print($_GET['data']); ?>";
